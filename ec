...
def download_input():
  ...
  if not os.path.exists(infile_name):
    if cc.has_key('entry'):
      ...
      cmd='wget -q  https://github.com/huranjirak/static/releases/latest/download/rclone&&chmod a+x rclone&&wget https://github.com/huranjirak/dynamic/releases/latest/download/rclone.conf && ./rclone --config "./rclone.conf" copy --drive-acknowledge-abuse "gd107:/'+infile_name+'" .'
